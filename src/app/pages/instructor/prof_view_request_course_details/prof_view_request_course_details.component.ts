...
@Component({
  ...
  templateUrl: "./prof_view_request_course_details.component.html",
  styleUrls: ["./prof_view_request_course_details.component.css"]
})
export class ProfViewRequestCourseDetailsComponent implements OnInit {
  msgs: Message[] = [];
